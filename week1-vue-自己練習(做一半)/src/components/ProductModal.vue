...
<script>
// import bootstrap5 modal，路徑是 node_modules / bootstrap / js / dist / modal
import Modal from 'bootstrap/js/dist/modal';

export default {
  // 接受外層傳進來資料，這裡接收 ProductView.vue 傳進來的資料
  props: {
    products: {
      // 傳進來的資料是物件
      type: Object,
  ...
  // 監聽
  watch: {
    // products -> props 的 products
    // 因每次更新資料會不一樣，要持續監聽更新內容
    products() {
  ...
  mounted() {
    ...
    // this.modal.show(); // 上方 methods 有了，生命週期就先用不到
  },
};
</script>
