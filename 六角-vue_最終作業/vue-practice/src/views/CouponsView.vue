...
export default {
  ...
  methods: {
    ...
    getCoupons() {
      this.isLoading = true;
      const url = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_API_PATH}/admin/coupons`;
    ...
    updateCoupon(tempCoupon) {
      if (this.isNew) {
        const url = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_API_PATH}/admin/coupon`;
        ...
        const url = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_API_PATH}/admin/coupon/${this.tempCoupon.id}`;
