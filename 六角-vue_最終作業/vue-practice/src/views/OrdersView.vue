...
export default {
  ...
  methods: {
    getOrders(currentPage = 1) {
      ...
      const url = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_API_PATH}/admin/orders?page=${currentPage}`;
      this.isLoading = true;
    ...
    delOrder() {
      const url = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_API_PATH}/admin/order/${this.tempOrder.id}`;
      this.isLoading = true;
