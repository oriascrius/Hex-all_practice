<template>
  ...
  <!-- 分頁 -->
  <!-- :pages="pagination" ->
  :pages 是內層 pagination  props: ['pages']
  pagination 是 data ( 而 data 的 pagination 資料從 遠端API 傳來)  -->
  <!-- @emit-pages="getProducts" ->
  @emit-pages 是內層 methods updatePage this.$emit('emit-pages', page)
  getProducts 是 方法並把內層傳出的 page 用參數接收  -->
